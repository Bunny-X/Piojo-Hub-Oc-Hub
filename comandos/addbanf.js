...
async execute (client, message, args){
  ...
  if(!botperms){
    ...
    if (!isActive) {
      ...
      .setDescription("<:Converter:995595217782718475> Anti-flood warning event is not active.\n Mode of use: `.setanti-flood on`")
      .setColor(color)
